...
export default {
  data: () => {
    return {
      ...
      configData: {},
      typeList: [
          { name: "int", value: "java.lang.Integer", secondName: "int整数" },
          { name: "string", value: "java.lang.String", secondName: "字符串" },
          { name: "long", value: "java.lang.Long", secondName: "long整数" },
          { name: "float", value: "java.lang.Float", secondName: "单精度浮点数" },
          { name: "double", value: "java.lang.Double", secondName: "双精度浮点数" },
          { name: "int数组", value: "", secondName: "int数组" },
          { name: "string数组", value: "", secondName: "string数组" },
          { name: "long数组", value: "", secondName: "long数组" },
          { name: "float数组", value: "", secondName: "单精度浮点数数组" },
          { name: "double数组", value: "", secondName: "双精度浮点数数组" },
          { name: "Map<String, String>", value: "", secondName: "Map类型" },
          { name: "Map<String, Integer>", value: "", secondName: "Map类型" },
        ]
    };
  },
  computed: {
